        ...
        btnNewButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
                ...
                if (tableModel.getRowCount() == 0) {
                    JOptionPane.showMessageDialog(null, "Cart is empty. Add items to cart before checkout.");
                    return;
                }
                ...
                logbook.addItemToTable(new Object[] { "Customer Name:", customerName, "Contact No:", contactNumber });
                ...
                logbook.addItemToTable(new Object[] { "", "", "", "" });
